...
**⚠️ STOP (INTERACTIVE mode):** Present the accept/reject recommendation with full data. In AUTONOMOUS mode: proceed with the recommendation automatically.
...
Wait for user confirmation (INTERACTIVE mode only).
