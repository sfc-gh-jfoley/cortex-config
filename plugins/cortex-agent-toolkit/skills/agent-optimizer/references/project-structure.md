...
├── flag_sweep_baseline.json                 # Flag/model sweep baseline (written by agent-model-tester, read by optimize Step 10)
...
│   ├── deploy.sql
│   ├── optimization_log.md
│   ├── flag_sweep_baseline.json             # Flag/model sweep baseline (written by agent-model-tester)
│   ├── metadata.yaml
