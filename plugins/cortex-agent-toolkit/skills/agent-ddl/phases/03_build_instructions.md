---
name: agent-ddl-phase3-instructions
...
Wait for user approval before loading Phase 4 (INTERACTIVE mode). **AUTONOMOUS:** accept the
drafted instructions if the 5 best-practices checks (referenced above) all pass; log and
proceed. This is a courtesy checkpoint on drafted text, not a data-integrity gate.
